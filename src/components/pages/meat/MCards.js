  ...
  return (
    <div className="meatcards">
      <div className="top">
        <h1>Our Meat.</h1>
        <h2>
          What makes our meat so tastey is the way the lambs are fed. They are
          fed Walton's alfalfa pellets mixed with 4-H grain (that is made up of
          oats , barley, corn, molasses, canola, urea, and protein premix) with
          free choice grass hay. They are butchered between 150 - 200 pounds.
          Our lamb is served at Half Moon Lake Resturaunt and is also available
          for purchase at Obo's Specialty Meats Market.
        </h2>
      </div>
          ...
          <div className="cards__wrapper">
            <ul className="cards__items">
              <CardItem
                ...
                label="Click to Buy your Whole Lamb"
                path="/meat-form"
              />
